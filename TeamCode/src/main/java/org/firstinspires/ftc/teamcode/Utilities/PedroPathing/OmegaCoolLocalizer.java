 ...
 */
public class OmegaCoolLocalizer {
    private final GoBildaPinpointDriver odo;
    private final OmegaCoolConstants constants;
     ...
     */
    public OmegaCoolLocalizer(HardwareMap map, OmegaCoolConstants constants){ this(map, constants, new Pose());}
     ...
     */
    @SuppressLint("NewApi")
    public OmegaCoolLocalizer(HardwareMap map, OmegaCoolConstants constants, Pose setStartPose){
