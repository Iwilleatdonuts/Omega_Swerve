package org.firstinspires.ftc.teamcode.Utilities.PedroPathing.drivetrains;
...
public class SwerveConstants {
    ...
    public String rightFrontEncoderName = "angleFeedback0";
    ...
    public PIDFCoefficients leftFrontTurnPID = new PIDFCoefficients(0.009, 0.004, 0.00, 0.0);
    public PIDFCoefficients rightFrontTurnPID = new PIDFCoefficients(0.009, 0.004, 0.00, 0.0);
    public PIDFCoefficients leftRearTurnPID = new PIDFCoefficients(0.009, 0.004, 0.00, 0.0);
    public PIDFCoefficients rightRearTurnPID = new PIDFCoefficients(0.009, 0.004, 0.00, 0.0);

    //TODO: Reverse motors if needed
    public DcMotorEx.Direction leftFrontMotorDirection = DcMotorSimple.Direction.FORWARD;
    public DcMotorEx.Direction rightFrontMotorDirection = DcMotorSimple.Direction.FORWARD;
    public DcMotorEx.Direction leftRearMotorDirection = DcMotorSimple.Direction.FORWARD;
    ...
    public double leftFrontPodAngleOffsetDeg = 271.5273;
    public double rightFrontPodAngleOffsetDeg = 149.7818;
    public double leftRearPodAngleOffsetDeg = 95.5636;
    public double rightRearPodAngleOffsetDeg = 192.4364;
