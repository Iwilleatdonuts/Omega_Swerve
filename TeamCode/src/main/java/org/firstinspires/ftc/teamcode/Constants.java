...
//        public static final double MAX_TICKS_PER_SEC = (MAX_MOTOR_RPM_THEORETICAL * TICKS_PER_REV) / 60.0;
    ...
    public static final class AutoConstants {
        ...
        public static final class RedConstants {
            ...
            public static final OmegaPose2D farStart = new OmegaPose2D(1.24088, 1.22156, 270);
            public static final OmegaPose2D closeShot = new OmegaPose2D(0.95, 0.95, 270);
            public static final OmegaPose2D farShot = new OmegaPose2D(0.3, 0.3, 270);
            ...
            public static final OmegaPose2D mediumBallPickup = new OmegaPose2D(1.3, -0.25, 260);
        ...
        public static final class BlueConstants {
            ...
            public static final OmegaPose2D mediumBallPickup = new OmegaPose2D(-1.3, -0.25, 100);
