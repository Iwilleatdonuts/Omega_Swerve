...
public class BetterBlue extends OpMode {
    ...
    private boolean areWeWinners = false;
    ...
    public void init_loop() {
        ...
        if(driver.wasJustPressed(GamepadKeys.Button.B)) {
            s_Sparky.configureOTOS(
                    s_Sparky.normiePoseToSparkyPose(Constants.AutoConstants.BlueConstants.mediumShotPositionForTeleop)
            );
        }

        if(driver.wasJustPressed(GamepadKeys.Button.Y)) {
            s_Sparky.configureOTOS(
                    s_Sparky.normiePoseToSparkyPose(Constants.AutoConstants.BlueConstants.gateLineupTeleop)
            );
        }
