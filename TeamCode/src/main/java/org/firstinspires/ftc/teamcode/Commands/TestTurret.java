...
public class TestTurret {
    ...
    public TestTurret(Swerve s_Swerve, Turret s_Turret, Limelight s_Lime, OTOSSensor s_Sparky, OmegaController m_Operator, OmegaController m_Driver, EZTelemetry telem, boolean areWeWinners){
